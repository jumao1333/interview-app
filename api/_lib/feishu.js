...
const QDATA = {
  content_leader: [
    ...
    {id:"qh4",type:"select",field_select:"QH4-失败归因权重",field_note:"QH4-失败归因理由"},
  ...
  content_editor: [
    ...
    {id:"qh2",type:"text",field_text:"QH2-AI最易写错内容"},
  ...
  broker_leader: [
    ...
    {id:"qh4",type:"text",field_text:"QH4-AI初筛8信息"},
  ...
  broker: [
    ...
    {id:"qh1",type:"text",field_text:"QH1-值得聊的信号"},
